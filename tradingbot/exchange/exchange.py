...
from tradingbot.exceptions import (DependencyException, InvalidOrderException, OperationalException, TemporaryError)
from tradingbot.exchange.common import BAD_EXCHANGES, retrier, retrier_async

#from tradingbot.misc import deep_merge_dicts
...
class Exchange:
    ...
    def __init__(self, config: Dict[str, Any], validate: bool = True) -> None:
        ...
        ccxt_async_config = deep_merge_dicts(exchange_config.get('ccxt_async_config', {}),ccxt_async_config)

        self._api_async = self._init_ccxt(exchange_config, ccxt_async, ccxt_kwargs=ccxt_async_config)
        ...
        self.markets_refresh_interval: int = exchange_config.get( "markets_refresh_interval", 60) * 60
    ...
    def _init_ccxt(self, exchange_config: Dict[str, Any], ccxt_module: CcxtModuleType = ccxt,ccxt_kwargs: dict = None) -> ccxt.Exchange:
        """
